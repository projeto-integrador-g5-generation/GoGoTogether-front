  ...
  function retornar() {
    ...
    return (
        <div className='container w-1/3 mx-auto'>
            <h1 className='text-4xl text-center py-4'>{translate('deletarVeiculo')}</h1>
            ...
            <div className="flex flex-col items-center p-4">
                ...
                <p className="text-sm text-center">{translate('ano')}: {veiculo.ano}</p>
                <p className="text-sm text-center">{translate('placa')}: {veiculo.placa}</p>
            </div>
