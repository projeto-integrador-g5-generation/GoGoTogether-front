...
function CardViagens({ viagem }: CardViagemProps) {
  ...
  return (
    <div
      className={`flex flex-col rounded-lg overflow-hidden justify-between mx-4 my-10 hover:shadow-lg ${
        theme === "light" ? "bg-white text-black" : "bg-black text-white"
      } shadow-lg hover:scale-101 transition-all`}
    >
      ...
      <div className="flex flex-col justify-center py-2">
        <div className="p-2">
          ...
          <div className="flex flex-col bg-emerald-100 mt-3 p-2 rounded-lg text-black">
