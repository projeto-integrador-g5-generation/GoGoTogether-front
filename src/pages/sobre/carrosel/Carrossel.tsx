        ...
        {membros
          ...
          .map((membro, idx) => (
            <div
              key={idx}
              className={`${
        theme === "light" ? "bg-gray-200 text-black" : "bg-black text-white"
      }"border border-gray-300 rounded-lg p-6 w-90 h-72 mx-auto  shadow-md hover:shadow-lg transition-shadow duration-300"`}
            >
